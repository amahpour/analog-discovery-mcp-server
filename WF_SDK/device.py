...
if platform.startswith("win"):
    ...
    # on macOS - try WaveForms.app bundle first, then system location
    lib_paths = [
        sep + "Applications" + sep + "WaveForms.app" + sep + "Contents" + sep + "Frameworks" + sep + "dwf.framework" + sep + "Versions" + sep + "A" + sep + "dwf",
    ...
    for lib_path in lib_paths:
        try:
            ...
            continue
    if dwf is None:
        raise OSError("Could not find dwf framework. Please ensure WaveForms SDK is installed.")
